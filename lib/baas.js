...
/*Db.connect.Cursor.prototype._toArray = Db.connect.Cursor.prototype.toArray;
Db.connect.Cursor.prototype.toArray = function(callback) {
	this._toArray(function(err, docs) {
...
Baas.prototype.api = {
	...
	sandbox:function(handler) {
		fs.readFile('./sandbox.html', 'utf-8', function(err,data){
			if(err) {
